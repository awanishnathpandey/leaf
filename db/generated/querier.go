...
type Querier interface {
	...
	GetGroupFiles(ctx context.Context, groupID int64) ([]GetGroupFilesRow, error)
	GetGroupFolders(ctx context.Context, groupID int64) ([]GetGroupFoldersRow, error)
	GetGroupUsers(ctx context.Context, groupID int64) ([]GetGroupUsersRow, error)
