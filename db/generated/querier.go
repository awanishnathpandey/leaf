...
type Querier interface {
	...
	GetNotificationTemplate(ctx context.Context, id int64) (NotificationTemplate, error)
	...
	PaginatedUsers(ctx context.Context, arg PaginatedUsersParams) ([]PaginatedUsersRow, error)
